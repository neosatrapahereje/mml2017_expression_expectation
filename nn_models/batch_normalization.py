...
from lasagne.layers import (MergeLayer, Layer, Gate, BatchNormLayer)
...
class BatchNormLSTMLayer(MergeLayer):
    """
    ...
    def __init__(self, incoming, num_units,
        ...
        super(BatchNormLSTMLayer, self).__init__(incomings, **kwargs)
        ...
        if bn:
            self.bn = BatchNormLayer(input_shape, axes=(0,1))  # create BN layer for correct input shape
    ...
    def get_output_for(self, inputs, **kwargs):
        ...
        def step_masked(input_n, mask_n, iter_idx, cell_previous, hid_previous, *args):
